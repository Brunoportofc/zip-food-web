...
async def run_test():
    ...
    try:
        ...
        # Click on delivery profile button to select delivery driver login
        frame = context.pages[-1]
        ...
        # Click accept delivery button for the first available order (#1000 Burger King)
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div/main/div/div[2]/div[3]/div/div[2]/div[4]/div/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the online toggle button to go online (available)
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/aside/nav/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
